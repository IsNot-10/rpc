...
class RpcHeader_MetaDataEntry_DoNotUse;
struct RpcHeader_MetaDataEntry_DoNotUseDefaultTypeInternal;
extern RpcHeader_MetaDataEntry_DoNotUseDefaultTypeInternal _RpcHeader_MetaDataEntry_DoNotUse_default_instance_;
}  // namespace mprpc
PROTOBUF_NAMESPACE_OPEN
template<> ::mprpc::RpcHeader* Arena::CreateMaybeMessage<::mprpc::RpcHeader>(Arena*);
template<> ::mprpc::RpcHeader_MetaDataEntry_DoNotUse* Arena::CreateMaybeMessage<::mprpc::RpcHeader_MetaDataEntry_DoNotUse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace mprpc {

// ===================================================================

class RpcHeader_MetaDataEntry_DoNotUse : public ::PROTOBUF_NAMESPACE_ID::internal::MapEntry<RpcHeader_MetaDataEntry_DoNotUse, 
    std::string, std::string,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING> {
public:
  typedef ::PROTOBUF_NAMESPACE_ID::internal::MapEntry<RpcHeader_MetaDataEntry_DoNotUse, 
    std::string, std::string,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING> SuperType;
  RpcHeader_MetaDataEntry_DoNotUse();
  explicit PROTOBUF_CONSTEXPR RpcHeader_MetaDataEntry_DoNotUse(
      ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  explicit RpcHeader_MetaDataEntry_DoNotUse(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  void MergeFrom(const RpcHeader_MetaDataEntry_DoNotUse& other);
  static const RpcHeader_MetaDataEntry_DoNotUse* internal_default_instance() { return reinterpret_cast<const RpcHeader_MetaDataEntry_DoNotUse*>(&_RpcHeader_MetaDataEntry_DoNotUse_default_instance_); }
  static bool ValidateKey(std::string* s) {
    return ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(s->data(), static_cast<int>(s->size()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE, "mprpc.RpcHeader.MetaDataEntry.key");
 }
  static bool ValidateValue(std::string* s) {
    return ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(s->data(), static_cast<int>(s->size()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE, "mprpc.RpcHeader.MetaDataEntry.value");
 }
...
// map<string, string> meta_data = 4;
inline int RpcHeader::_internal_meta_data_size() const {
  return _impl_.meta_data_.size();
}
inline int RpcHeader::meta_data_size() const {
  return _internal_meta_data_size();
}
inline void RpcHeader::clear_meta_data() {
  _impl_.meta_data_.Clear();
}
inline const ::PROTOBUF_NAMESPACE_ID::Map< std::string, std::string >&
RpcHeader::_internal_meta_data() const {
  return _impl_.meta_data_.GetMap();
}
inline const ::PROTOBUF_NAMESPACE_ID::Map< std::string, std::string >&
RpcHeader::meta_data() const {
  // @@protoc_insertion_point(field_map:mprpc.RpcHeader.meta_data)
  return _internal_meta_data();
}
inline ::PROTOBUF_NAMESPACE_ID::Map< std::string, std::string >*
RpcHeader::_internal_mutable_meta_data() {
  return _impl_.meta_data_.MutableMap();
}
inline ::PROTOBUF_NAMESPACE_ID::Map< std::string, std::string >*
RpcHeader::mutable_meta_data() {
  // @@protoc_insertion_point(field_mutable_map:mprpc.RpcHeader.meta_data)
